...
LH=Torso["Left Hip"]
RH=Torso["Right Hip"]
TorsoColor=BrickColor.new("Dark red")
...
MagicCircle(BrickColor.new("Dark red"), par.CFrame, 1, 1, 1, 1, 1, 1, 0.05)
end
...
EyePart.Color = Color3.new(1, 0.2, 0.2) -- vermelho brilhante nos olhos
...
for i=0,30 do
swait(1)
MagicRing(BrickColor.new("Dark red"), Gear.CFrame*CFrame.Angles(math.rad(math.random(0,360)),math.rad(math.random(0,360)),math.rad(math.random(0,360))), 20, 20, 2, 1, 1, 1, -1, -1, 0)
MagicRing(BrickColor.new("Dark red"), Gear2.CFrame*CFrame.Angles(math.rad(math.random(0,360)),math.rad(math.random(0,360)),math.rad(math.random(0,360))), 20, 20, 2, 1, 1, 1, -1, -1, 0)
MagicRing(BrickColor.new("Dark red"), DragonHead.CFrame*CFrame.Angles(math.rad(math.random(-50,50)),math.rad(math.random(-50,50)),math.rad(math.random(-50,50))), 60, 60, 6, 1, 1, 1, -3, -3, 0)
end
swait(180)
so(233096557,Torso,1,5)
so(233091205,Torso,1,5)
so(150829983,DragonHead,.9,5)
MagicCircle(BrickColor.new("Dark red"), Gear.CFrame, 10, 10, 10, 1, 1, 1, 0.01)
MagicCircle(BrickColor.new("Dark red"), Gear2.CFrame, 10, 10, 10, 1, 1, 1, 0.01)
MagicCircle(BrickColor.new("Dark red"), DragonHead.CFrame, 20, 20, 20, 1, 1, 1, 0.01)
Gear.Transparency = 0
...
for i=1,150 do
MagicRing(BrickColor.new("Dark red"), DragonHead.CFrame * CFrame.new(0,0,-5) * CFrame.Angles(math.rad(math.random(0,360)),math.rad(math.random(0,360)),math.rad(math.random(0,360))), 20, 20, 2, 1, 1, 1, -1, -1, 0)
handleweld.C0 = cf(math.random(-5,5)/10,math.random(55,65)/10,math.random(65,75)/10)*angles(math.rad(50),math.rad(0),math.rad(0))
swait()
end
for i=0,1,0.05 do
